  ...
  */
  ...
  function popperGenerator(generatorOptions) {
    ...
    return function createPopper(reference, popper, options) {
      ...
      var instance = {
        ...
        // Sync update ¨C it will always be executed, even if not necessary. This
        ...
        // Async and optimistically optimized update ¨C it will not be executed if
  ...
  function flip(_ref) {
    ...
    if (makeFallbackChecks) {
      // `2` may be desired in some cases ¨C research later
